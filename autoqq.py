...
for current_url in home_urls:
    ...
    while i < times:
        ...
        form_data2 = {'email': ''.join(random.choice(string.ascii_letters+string.digits) for _ in range(12))+'@qq.com',
                    'password': 'nichacha123',
                    'invite_code': '',
                'email_code': ''}
        try:
        ...
        try:
            ...
            subsqq.append(subscription_url)
        except:
